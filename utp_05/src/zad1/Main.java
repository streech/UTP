...
public class Main {
  public static void main(String[] args) {
    ...
    XList<List<String>> toCombine = XList.of(sa, sb, sc);          // czy można tu uniknąć użycia typu surowego? Tak
    ...
    // Odpowiedź: metoda forEachWithIndex przyjmuje interfejs funkcyjny BiConsumer dwu parametrowy.
    // Jako pierwszy parametr otrzymujemy element XListy a jako drugi indeks tego elementu.
    // Powyższy kod sprawia, że pozbywamy się elementów z indeksów parzystych.
    // Jeśli użyjemy enhanced for loop'a to otrzymamy wyjątek ConcurrentModification ponieważ
    // tego typu pętla nie wykorzystuje interfejsu iterable, który jest niezbędny aby móc wykonać
    // operacje modyfikujące kolekcję. Rozwiązaniem tego problemu jest uzycie podstawowego for loop'a
    // lub stworzenie iteratora dla listy -> this.iterator();
  }
}